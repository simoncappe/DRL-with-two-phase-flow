...
write_border((0,-1),3*r/2,(P1+P2)/2,name = 'M1')
write_border((0,1),3*r/2,mirror((P1+P2)/2),name = 'M2')


write_border((1,0),3*r/2,(P3+P2)/2 + epsilon*ey/10000,name = 'M3')
write_border((1,0),3*r/2,mirror((P3+P2)/2)-epsilon*ey/10000,name = 'M4')
