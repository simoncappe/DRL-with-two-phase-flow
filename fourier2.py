...
montee = 0.5*periode
descente1 = 0.05*periode
descente2 = descente1
descente3 = 0.15*periode


t = np.linspace(0,periode*2,300)


print((montee+epsilon+descente1+descente2+descente3)/periode)
...
def f(x):
    ...
    elif x_< montee+epsilon+descente1+descente2+descente3:
        return affine(montee+epsilon+descente1+descente2+descente3,0,montee+descente1+epsilon,step1,x_)
    else:
        return 0
